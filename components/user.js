...
exports.userReg = async (req, res) => {
    try {
        ...
        if (!req.body.emailId || !req.body.password || !req.body.firstName) {
            throw new Error("Missing required fields: emailId, password, firstName")
        }
        ...
        //If email ID present in database throws error and return message
        if (user) {
            throw new Error("Email Id already present please login!")
        }
        ...
        const savedUser = await model.User.create(newUser)
